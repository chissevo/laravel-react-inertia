                            ...
                            <div className="overflow-auto">
                                <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                    ...
                                    <tbody>
                                        {
                                            users.data.map((user) => (
                                                <tr className=" bg-white dark:bg-gray-800 border-b dark:border-gray-700" key={user.id}>
                                                    <th className="px-3 py-3">{ user.id }</th>
                                                    <th className="px-3 py-2 text-gray-100 text-wrap">
                                                        { user.name }
                                                    </th>
                                                    <th className="px-3 py-3">
                                                        { user.email }
                                                    </th>
                                                    <th className="px-3 py-3">{ user.created_at }</th>
