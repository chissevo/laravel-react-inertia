...
export default function Create({auth, enterprise, address, success})
{
    const {data, setData, post, errors, reset } = useForm({
        name:           enterprise.name   || "",
        nif:            enterprise.nif  || "",
        joint_stock:    enterprise.joint_stock  || "",
    ...
    const onSubmit = (e) => {
        e.preventDefault();
        post(route("enterprise.update", enterprise.id));
    }
            ...
            header={
                <div className="flex justify-between items-center">
                    <h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                        Editar Dados da Empresa: { enterprise.name }
                    </h2>
                </div>
            }>
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <form onSubmit={onSubmit} className="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                            { enterprise.logo_image &&
                              <div className="mb-4">
                                  <img src={ enterprise.logo_image } className="w-64" />
                              </div>
                            }
                            <pre>{  }</pre>
