...
import EnterprisesTable from "./EnterpriseTable";


export default function Index({ auth, enterprises, queryParams = null, success })
{
  return (
    <AuthenticatedLayout
        user={ auth.user }
          ...
          <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div className="p-6 text-gray-900 dark:text-gray-100">
              <div className="overflow-auto">
                <EnterprisesTable enterprises={enterprises} queryParams={queryParams}/>
              </div>
            </div>
          </div>
        </div>
