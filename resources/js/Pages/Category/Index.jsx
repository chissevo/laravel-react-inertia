...
import CategorysTable from "./CategoryTable";


export default function Index({auth, category, queryParams = null, success, users})
{
    return (
        <AuthenticatedLayout
            user={auth.user}
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900 dark:text-gray-100">
                            <CategorysTable category={category} queryParams={queryParams}/>
                        </div>
                    </div>
                </div>
            </div>
